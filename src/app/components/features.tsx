    ...
    return(
        ...
        <div className="flex flex-col gap-18 py-28 px-4 md:px-52">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
                ...
                <div className="flex flex-col backdrop-blur-2xl gap-6 border border-stone-300 overflow-hidden px-6 py-8 rounded-xl hover:shadow-[3px_6px_9px_rgba(0,0,0,0.3)] transition-all duration-200 ease-easeIn shadow-[0px_3px_7px_rgba(0,0,0,0.17)]">
                    ...
                    <div className="flex flex-col backdrop-blur-2xl overflow-hidden gap-6 border border-stone-300 px-6 py-8 rounded-xl hover:shadow-[3px_6px_9px_rgba(0,0,0,0.3)] transition-all duration-200 ease-easeIn shadow-[0px_3px_7px_rgba(0,0,0,0.17)]">
                    <div className="relative">
